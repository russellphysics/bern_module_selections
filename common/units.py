################################################################################
##                                                                            ##
##    CONTAINS: Common set of units for Bern module data. Originally used for ##
##              Module 0 data. Adapted from: https://github.com/DUNE/         ##
##              ndlar_flow/blob/main/src/module0_flow/util/units.py           ##
##                                                                            ##
################################################################################
