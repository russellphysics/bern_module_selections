################################################################################
##                                                                            ##
##    CONTAINS: Class designed to create event displays for Bern Module data. ##
##              Identical to https://github.com/larpix/                       ##
##              larpix-v2-testing-scripts/blob/master/event-display/          ##
##              module0_evd.py with some minor modifications for usability.   ##
##              To run, use/modify run_module0_evd.py script.                 ##
##                                                                            ##
################################################################################
